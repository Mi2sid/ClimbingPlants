...
java -Xmx%POWER% -cp "build;%PROCESSING_PATH%\core\library\core.jar;%PROCESSING_PATH%\core\library\jogl-all.jar;%PROCESSING_PATH%\core\library\gluegen-rt.jar;" -Djava.library.path=%PROCESSING_PATH%\core\library\windows-amd64 PApp
